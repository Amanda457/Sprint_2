...
SELECT departamento.nombre, apellido1, apellido2, persona.nombre FROM persona RIGHT JOIN profesor ON persona.id = profesor.id_profesor RIGHT JOIN departamento ON profesor.id_departamento = departamento.id WHERE tipo = "profesor" ORDER BY departamento.nombre, apellido1, persona.nombre ASC;
SELECT persona.nombre FROM persona RIGHT JOIN profesor ON persona.id = profesor.id_profesor WHERE profesor.id_departamento IS NULL;
SELECT departamento.nombre FROM departamento RIGHT JOIN profesor ON departamento.id = profesor.id_departamento WHERE profesor.id_departamento IS NULL;
